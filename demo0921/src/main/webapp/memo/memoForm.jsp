...
<body>
	...
	<div>
		<form id="f_memo" method="get" action="/memo/memoInsert">
			...
			<input id="memo_content" name="memo_content" multiline="true" class="easyui-textbox" style="width:450px; height:300px;"/>
		</form>
		<a href="javascript:memoSend()" class="easyui-linkbutton">전송하기</a>
	</div>
</body>
</html>
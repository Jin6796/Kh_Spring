	...
	public void setPageBar() {
		...
		if(totalRecord>0) {
			...
			for(int i=0;i<pagePerBlock;i++) {
				...
				//주의할 것. - NullPointer 발생 우려 --> 무한루프 방지 코드를 쓰자!
